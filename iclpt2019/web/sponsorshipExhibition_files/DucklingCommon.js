...
function ImageScroller(id, images,time){
	this.images = images;
	this.current =0;
	this.imageId=id;
	
	imgEl = document.getElementById(this.imageId);
	imgEl.onload=changeImageSize;
	imgEl.scroller=this;
	this.nextImage=function(){
		...
		imgEl=document.getElementById(this.imageId);
		imgEl.src=images[this.current];
	};
	setInterval(function(){
		var img = document.getElementById(id);
		img.scroller.nextImage();
	}, time);
}
